...
import com.track_assist.databinding.ActivityMapFragmentBinding;

public class Map_fragment extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityMapFragmentBinding binding;
